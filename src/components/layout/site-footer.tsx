...
export function SiteFooter() {
  return (
    <footer className="px-4 pb-6 pt-14 sm:px-6 lg:px-8">
      <div className="premium-card-strong mx-auto grid w-full max-w-7xl gap-8 rounded-[2rem] px-6 py-8 sm:px-8 lg:grid-cols-[1.2fr_0.8fr_0.8fr]">
        <div>
        ...
        <div>
          ...
          <div className="mt-4 space-y-3 text-sm text-slate-600 dark:text-slate-300">
            <Link href="/units" className="flex items-center gap-2 transition hover:text-sky-700 dark:hover:text-sky-400">
              <Languages className="size-4" /> الوحدات التعليمية
            </Link>
            <Link href="/lessons" className="flex items-center gap-2 transition hover:text-sky-700 dark:hover:text-sky-400">
              <BookOpenCheck className="size-4" /> كل الدروس
            </Link>
            <Link href="/dashboard" className="flex items-center gap-2 transition hover:text-sky-700 dark:hover:text-sky-400">
